import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, T as TrendingUp } from "./index-yHXBoh2M.js";
import { e as useActiveWallets, f as useSubmitDeposit, P as PackageTier, C as Copy } from "./useBackend-Cclt7pt4.js";
import { a as Button, B as Badge } from "./button-CQccDo7r.js";
...
const PACKAGES = [
  ...
  {
    tier: PackageTier.EXECUTIVE,
    name: "Executive",
    min: 4e4,
    max: 49999,
    daily: 1.16,
    weekly: 8.12,
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Crown, { className: "w-6 h-6" }),
    tagline: "High-performance tier",
    color: "border-border hover:border-primary/60"
  },
  {
    tier: PackageTier.SIGNATURE,
    name: "Signature",
    min: 5e4,
    max: 74999,
    daily: 1.18,
    ...
    step === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: PACKAGES.map((pkg, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            PackageCard,
            {
              pkg,
