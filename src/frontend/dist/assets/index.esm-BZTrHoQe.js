import { j as jsxRuntimeExports, b as cn, o } from "./index-yHXBoh2M.js";
...
const HookFormControlContext = o.createContext(null);
...
const useIsomorphicLayoutEffect = typeof window !== "undefined" ? o.useLayoutEffect : o.useEffect;
...
const HookFormContext = o.createContext(null);
...
function useForm(props = {}) {
  const _formControl = o.useRef(void 0);
  const _values = o.useRef(void 0);
  const [formState, updateFormState] = o.useState({
    isDirty: false,
    isValidating: false,
  ...
  o.useEffect(() => control._disableForm(props.disabled), [control, props.disabled]);
  o.useEffect(() => {
    if (props.mode) {
  ...
  _formControl.current.formState = o.useMemo(() => getProxyFormState(formState, control), [control, formState]);
