import { c as createLucideIcon, e as useQueryClient, r as reactExports, j as jsxRuntimeExports, T as TrendingUp, b as cn, d as useAuth } from "./index-yHXBoh2M.js";
import { g as useAdminDeposits, h as useActor, i as createActor, j as useAdminUsers, k as useAdminWithdrawals, l as useAdminWallets, m as useUpsertWallet, n as useDeleteWallet, C as Copy, o as useClaimAdmin, p as useQuery } from "./useBackend-Cclt7pt4.js";
import { u as ue } from "./index-CBbNEILV.js";
import { a as Button, B as Badge, u as useComposedRefs, b as buttonVariants } from "./button-CQccDo7r.js";
import { D as DollarSign, C as CircleX, a as Dialog, c as DialogContent, d as DialogHeader, e as DialogTitle, f as DialogFooter, R as Root$1, W as WarningProvider, g as Content, T as Title, h as Description, i as Close, j as createDialogScope, P as Portal, O as Overlay, k as Trigger } from "./dialog-Dvu6V8ye.js";
import { L as Label } from "./label-DQHZ_mSW.js";
import { T as Textarea, u as useForm } from "./index.esm-BZTrHoQe.js";
import { C as CircleCheck } from "./circle-check-BDQKSLDB.js";
import { U as Users } from "./users-DJKlo4PO.js";
import { C as ChartColumn, A as ArrowRight } from "./chart-column-BNe9gO74.js";
import { W as Wallet } from "./wallet-W8SPTi1W.js";
import { I as Input } from "./input-vNc25_85.js";
import { S as Search } from "./search-BZv8X59e.js";
import { f as composeEventHandlers, j as createSlottable, c as createContextScope, d as useControllableState, P as Primitive } from "./Combination-CMyXfHUG.js";
import { a as usePrevious, u as useSize, C as Check } from "./index-C4gV_dGK.js";
import { S as Shield } from "./shield-CXB-oIXE.js";
/**
...
function AdminPage() {
  ...
  function handleClaimAdmin() {
    if (!principal) {
      ue.error("No principal found. Please log in first.");
      return;
    }
    claimAdmin(principal, {
      onSuccess: () => {
        ue.success("Admin access claimed! Reloading panel…");
      },
      onError: (err) => {
        ue.error(
          err instanceof Error ? err.message : "Failed to claim admin access. An admin may already be assigned."
        );
      }
    });
  }
  if (!isAdmin) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-6 max-w-sm px-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-primary/20 rounded-xl p-4 bg-primary/5 space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: "If you are the site owner, click below to claim admin access. This only works if no admin has been assigned yet." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                children: isClaiming ? "Claiming Access…" : "Claim Admin Access"
              }
            ),
            principal && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground font-mono break-all", children: [
              "Principal: ",
              principal
            ] })
          ] })
