import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, L as Link, T as TrendingUp } from "./index-yHXBoh2M.js";
import { B as Badge, a as Button } from "./button-CQccDo7r.js";
import { r as resolveElements, m as motion } from "./proxy-B_HWoVK_.js";
import { A as ArrowRight, C as ChartColumn } from "./chart-column-BNe9gO74.js";
import { C as ChevronRight } from "./chevron-right-l27Iy5sJ.js";
import { C as CircleCheckBig, S as Star } from "./star-DvNHPc7D.js";
      ...
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(FadeSection, { className: "text-center mb-16", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground max-w-xl mx-auto", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto", children: "12 tiers designed for every investor profile — from first-time crypto investors to institutional-level professionals." }),
              "crypto investors to seasoned professionals."
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6", children: PACKAGES.map((pkg, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(FadeSection, { delay: i * 0.12, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-3xl mx-auto px-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(FadeSection, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg mb-10 max-w-xl mx-auto", children: "Join 10,000+ investors already building wealth with GoNext's institutional-grade arbitrage platform. Start today — minimum deposit $50." }),
